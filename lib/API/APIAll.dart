...
Future<List<Question>> fetchQuizLyThuyet() async {
  final response = await http.get(Uri.parse('https://7741-113-161-66-197.ngrok-free.app/mavenproject1/api/v1/questions')); // Thay API URL vào đây
